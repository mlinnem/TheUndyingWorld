...
In addition to the resulting scene block, make sure to include the condition table to begin with good habits. Recall all prior instructions on how to conduct gameplay.
