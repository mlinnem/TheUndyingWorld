...
Describe now the artifact and questline that results in the ''dark ending' outcome.
...
Describe now the artifact and questline that results in the ''save your community' outcome.
...
Describe now the artifact and questline that results in the ''save your family' outcome.

Because this outcome is fairly good (saves you, your family) it should be relatively difficult for a 'first playthrough' type ending. It should entail obtaining two artifacts. It should be immediately obvious, but should become obvious if the player doggedly pursues the family members as a primary priority.

# Instruction

Describe now the artifact and questline that results in the ''save yourself' outcome.

This outcome should actually be relatively easy to achieve, because a fairly mediocre ending. It should entail obtaining two artifacts. It should become fairly obvious as a questline to pursue as the player becomes fairly engaged with the game. It is a temptation, and also an alternative to total destruction that the player may take as a failsafe.
...
Describe the situation with respect to your children (one age six, the other age sixteen). Where are they? What is their state of affairs?
